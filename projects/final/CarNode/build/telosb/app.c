...
struct _reent {
  ...
  void (*__cleanup)(struct _reent *arg_0x403243b8);
  ...
  void (**_sig_func)(int arg_0x40322a70);
...
typedef nx_struct test_car_msg {
  nx_uint32_t seq;
  nx_uint16_t cmd;
} __attribute__((packed)) test_car_msg_t;
...
typedef TMilli CarP__Timer1__precision_tag;
enum /*CarC.Resourceusart0*/Msp430Uart0C__0____nesc_unnamed4316 {
...
enum /*CarC.Resourceusart0.UsartC*/Msp430Usart0C__1____nesc_unnamed4317 {
...
# 73 "/opt/tinyos-2.1.1/tos/interfaces/BigQueue.nc"
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void RadioToLedsC__DataSend__sendDone(
#line 92
message_t * msg, 
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void RadioToLedsC__DataControl__startDone(error_t error);
#line 117
static void RadioToLedsC__DataControl__stopDone(error_t error);
...
uint8_t len);
# 9 "Car.nc"
static void RadioToLedsC__Car__readDone(error_t state, uint16_t data);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void RadioToLedsC__CarControl__startDone(error_t error);
#line 83
...
# 213 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart.nc"
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static void /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 85
message_t * msg, 
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void CarP__Timer1__fired(void );
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
static void CarP__uart0resource__granted(void );
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t CarP__CarControl__start(void );
# 6 "Car.nc"
static error_t CarP__Car__Back(uint16_t value);
static error_t CarP__Car__QuiryReader(uint8_t value);
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static void CarP__recvTask__runTask(void );
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
...
uint8_t arg_0x408e4108);
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
static bool /*Msp430Uart0P.UartP*/Msp430UartP__1__Resource__isOwner(
# 43 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartP.nc"
uint8_t arg_0x408e4108);
# 54 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
...
# 48 "/opt/tinyos-2.1.1/tos/system/BigQueueC.nc"
...
# 90 "/opt/tinyos-2.1.1/tos/interfaces/BigQueue.nc"
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t RadioToLedsC__DataSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
#line 83
static error_t RadioToLedsC__DataControl__start(void );
# 115 "/opt/tinyos-2.1.1/tos/interfaces/Packet.nc"
static 
#line 112
void * 
...
RadioToLedsC__DataPacket__getPayload(
#line 110
message_t * msg, 
...
uint8_t len);
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void RadioToLedsC__ResendTimer__startPeriodic(uint32_t dt);
# 6 "Car.nc"
static error_t RadioToLedsC__Car__Back(uint16_t value);
static error_t RadioToLedsC__Car__QuiryReader(uint8_t value);




static error_t RadioToLedsC__Car__InitLeftServo(uint16_t value);
static error_t RadioToLedsC__Car__InitRightServo(uint16_t value);
#line 8
static error_t RadioToLedsC__Car__Pause(void );
#line 5
static error_t RadioToLedsC__Car__Forward(uint16_t value);
#line 4
static error_t RadioToLedsC__Car__Angle(uint16_t value);
...
static error_t RadioToLedsC__Car__InitMidServo(uint16_t value);
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t RadioToLedsC__CarControl__start(void );
# 56 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
static void RadioToLedsC__Leds__led0Toggle(void );
...
static void RadioToLedsC__Leds__led1Toggle(void );
#line 89
...
uint32_t RadioToLedsC__seq = 0;
uint16_t RadioToLedsC__init_angle = (3800 + 1800) / 2;

uint16_t RadioToLedsC__id;

uint16_t RadioToLedsC__current_data = 0;
uint16_t RadioToLedsC__resend_count = 0xfff;

static void RadioToLedsC__sendData(void );
...
static inline void RadioToLedsC__DataControl__startDone(error_t error);
#line 82
static inline void RadioToLedsC__AMControl__stopDone(error_t error);

static inline void RadioToLedsC__DataControl__stopDone(error_t error);
...
static void RadioToLedsC__sendData(void );
#line 237
static inline void RadioToLedsC__DataSend__sendDone(message_t *msg, error_t error);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
...
enum /*Counter32khz32C.Transform*/TransformCounterC__0____nesc_unnamed4355 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.Transform*/TransformAlarmC__0____nesc_unnamed4356 {
...
message_t *msg);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 56
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
static void /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.1.1/tos/system/AMQueueEntryP.nc"
static inline error_t /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
message_t * amsg);
# 118 "/opt/tinyos-2.1.1/tos/system/AMQueueImplP.nc"
enum /*AMQueueP.AMQueueImplP*/AMQueueImplP__1____nesc_unnamed4385 {
#line 118
...
#line 161
enum /*AMQueueP.AMQueueImplP*/AMQueueImplP__1____nesc_unnamed4386 {
#line 161
...
#line 49
#line 47
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP__1____nesc_unnamed4387 {
  message_t * msg;
...
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void CarP__Timer1__startOneShot(uint32_t dt);




static void CarP__Timer1__stop(void );
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
static error_t CarP__uart0resource__release(void );
#line 78
static error_t CarP__uart0resource__request(void );
#line 118
static bool CarP__uart0resource__isOwner(void );
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void CarP__CarControl__startDone(error_t error);
# 9 "Car.nc"
static void CarP__Car__readDone(error_t state, uint16_t data);
# 213 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart.nc"
static bool CarP__Usart__isTxEmpty(void );
#line 123
static void CarP__Usart__enableUart(void );
#line 180
static void CarP__Usart__enableRxIntr(void );
#line 224
static void CarP__Usart__tx(uint8_t data);
#line 174
static void CarP__Usart__setModeUart(msp430_uart_union_config_t *config);
# 56 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static error_t CarP__recvTask__postTask(void );
# 72 "CarP.nc"
enum CarP____nesc_unnamed4388 {
#line 72
  CarP__recvTask = 24U
};
#line 72
typedef int CarP____nesc_sillytask_recvTask[CarP__recvTask];
#line 55
bool CarP__isStart = FALSE;
bool CarP__isSend = FALSE;
error_t CarP__statetag = FAIL;
uint8_t CarP__CarCommand[7] = { 1, 2, 1, 0, 0, 255, 255 };
bool CarP__isUartDataOk = FALSE;
uint8_t CarP__rcvSyncDataSum = 0;
uint8_t CarP__SyncData[SYNC_DATA_SUM] = { 255, 255 };
uint8_t CarP__recdata[MAX_DATA];
uint8_t CarP__nreading = 0;
bool CarP__isBufFull = FALSE;
uint16_t CarP__tagdata = 0;


uint8_t CarP__cmdlength = 0;
...
static inline void CarP__SendString(uint8_t *ptr, uint8_t len);
...
static inline error_t CarP__CarControl__start(void );
#line 128
static error_t CarP__Car__Angle(uint16_t value);
#line 147
...
#line 331
static inline void CarP__uart0resource__granted(void );
#line 350
static inline void CarP__Timer1__fired(void );
#line 365
static inline void CarP__Interrupts__rxDone(uint8_t data);
#line 426
static inline void CarP__recvTask__runTask(void );
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartConfigure.nc"
...
static inline uint8_t /*Msp430Uart0P.UartP*/Msp430UartP__1__Resource__isOwner(uint8_t id);
...
static void /*Msp430Uart0P.UartP*/Msp430UartP__1__ResourceConfigure__configure(uint8_t id);
...
static inline error_t /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__default__isOwner(uint8_t id);
...
# 28 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x4067e4b0){
#line 28
  switch (arg_0x4067e4b0) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x4067e4b0);
#line 28
      break;
#line 28
    }
...
# 88 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x4128fdf8, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x4128fdf8, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40eac388){
#line 118
  unsigned char __nesc_result;
#line 118

#line 118
  switch (arg_0x40eac388) {
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40eac388);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40eacdd8){
#line 39
  union __nesc_unnamed4284 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40eacdd8);
#line 39
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x40b00a58){
#line 49
  switch (arg_0x40b00a58) {
#line 49
...
#line 49
      break;
#line 49
    case /*CarC.Resourceusart0.UsartC*/Msp430Usart0C__1__CLIENT_ID:
#line 49
      /*Msp430Uart0P.UartP*/Msp430UartP__1__ResourceConfigure__configure(/*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID);
#line 49
      break;
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x40b00a58);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x40b02690){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x40b02690);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40eac388){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40eac388);
#line 87
      break;
#line 87
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart0P.UartP*/Msp430UartP__1__Msp430UartConfigure__getConfig(uint8_t arg_0x408e01b8){
#line 39
  union __nesc_unnamed4288 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430Uart0P.UartP*/Msp430UartP__1__Msp430UartConfigure__default__getConfig(arg_0x408e01b8);
#line 39
...
#line 85
# 143 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart0P.nc"
static inline void HplMsp430Usart0P__Usart__setUmctl(uint8_t control)
#line 143
{
  U0MCTL = control;
...
#line 85
# 221 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart0P.nc"
static inline void HplMsp430Usart0P__Usart__disableUartTx(void )
#line 221
{
...
#line 78
# 227 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart0P.nc"
static inline void HplMsp430Usart0P__Usart__enableUartRx(void )
#line 227
{
...
#line 85
# 232 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart0P.nc"
static inline void HplMsp430Usart0P__Usart__disableUartRx(void )
#line 232
{
  HplMsp430Usart0P__ME1 &= ~(1 << 6);
...
#line 78
# 216 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart0P.nc"
static inline void HplMsp430Usart0P__Usart__enableUartTx(void )
#line 216
{
...
#line 182
# 256 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart0P.nc"
static inline void HplMsp430Usart0P__configSpi(msp430_spi_union_config_t *config)
#line 256
{
...
# 78 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40eac388){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40eac388);
#line 78
      break;
#line 78
    }
...
# 43 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__requested(uint8_t arg_0x40b02690){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__requested(arg_0x40b02690);
#line 43
}
#line 43
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40eac388){
#line 110
  unsigned char __nesc_result;
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40eac388);
#line 110
      break;
#line 110
    }
...
# 179 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart.nc"
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x40b00a58){
#line 55
  switch (arg_0x40b00a58) {
#line 55
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 55
    case /*CarC.Resourceusart0.UsartC*/Msp430Usart0C__1__CLIENT_ID:
#line 55
      /*Msp430Uart0P.UartP*/Msp430UartP__1__ResourceConfigure__unconfigure(/*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID);
#line 55
      break;
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x40b00a58);
#line 55
      break;
#line 55
    }
...
#line 54
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t CarP__uart0resource__release(void ){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  __nesc_result = /*Msp430Uart0P.UartP*/Msp430UartP__1__Resource__release(/*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID);
#line 110
...
#line 110
# 9 "Car.nc"
inline static void CarP__Car__readDone(error_t state, uint16_t data){
#line 9
  RadioToLedsC__Car__readDone(state, data);
#line 9
}
#line 9
...
inline static void CarP__Timer1__stop(void ){
#line 67
...
#line 430
  ...
  CarP__isBufFull = FALSE;
  CarP__isUartDataOk = FALSE;
  CarP__rcvSyncDataSum = 0;
  CarP__nreading = 0;
  if (CarP__statetag == FAIL) 
    {
      CarP__Car__readDone(CarP__statetag, 0xFFFF);
    ...
    {
      CarP__Car__readDone(CarP__statetag, CarP__tagdata);

      CarP__isSend = FALSE;
    }
  CarP__uart0resource__release();
}
...
# 115 "/opt/tinyos-2.1.1/tos/interfaces/Packet.nc"
inline static void * RadioToLedsC__DataPacket__getPayload(message_t * msg, uint8_t len){
#line 115
  void *__nesc_result;
#line 115
...
#line 115
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x40b76908, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x40b76908, addr, msg, len);
#line 69
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
inline static void /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 3);
  return /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}

# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t RadioToLedsC__DataSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 69
...
# 59 "/opt/tinyos-2.1.1/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x4128f780, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x4128f780, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x4128fdf8, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x4128fdf8, msg);
#line 95
}
#line 95
...
inline static void RadioToLedsC__Leds__led1Toggle(void ){
#line 72
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__release(uint8_t arg_0x408e1718){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x408e1718) {
#line 110
    case /*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID:
#line 110
      __nesc_result = /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__release(/*CarC.Resourceusart0.UsartC*/Msp430Usart0C__1__CLIENT_ID);
#line 110
      break;
#line 110
    default:
#line 110
      __nesc_result = /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__default__release(arg_0x408e1718);
#line 110
      break;
#line 110
    }
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  RadioToLedsC__DataSend__sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x40b79e48, message_t * msg, error_t error){
#line 89
  switch (arg_0x40b79e48) {
#line 89
    case 0U:
#line 89
      /*RadioToLedsAppC.DataSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x40b79e48, msg, error);
#line 89
      break;
#line 89
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x41216d58){
#line 92
  switch (arg_0x41216d58) {
#line 92
...
#line 92
    default:
#line 92
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x41216d58);
#line 92
      break;
#line 92
    }
...
# 56 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static error_t CarP__recvTask__postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(CarP__recvTask);
#line 56
...
#line 54
{
  if (RadioToLedsC__resend_count++ < 5) {
      RadioToLedsC__sendData();
    }
}
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x41170030){
#line 72
  switch (arg_0x41170030) {
#line 72
    case 1U:
#line 72
      CarP__Timer1__fired();
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x41170030);
#line 72
      break;
#line 72
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x4124fda0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x4124fda0, msg, payload, len);
#line 67
...
# 56 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void RadioToLedsC__Leds__led0Toggle(void ){
#line 56
...
#line 56
# 7 "Car.nc"
inline static error_t RadioToLedsC__Car__QuiryReader(uint8_t value){
#line 7
  unsigned char __nesc_result;
#line 7

#line 7
  __nesc_result = CarP__Car__QuiryReader(value);
#line 7
...
#line 7
#line 4
inline static error_t RadioToLedsC__Car__Angle(uint16_t value){
#line 4
  unsigned char __nesc_result;
#line 4
...
#line 4
# 211 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartP.nc"
static inline error_t /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__default__request(uint8_t id)
#line 211
{
#line 211
...
# 78 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__request(uint8_t arg_0x408e1718){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    case /*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID:
#line 78
      __nesc_result = /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__request(/*CarC.Resourceusart0.UsartC*/Msp430Usart0C__1__CLIENT_ID);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__default__request(arg_0x408e1718);
#line 78
      break;
#line 78
    }
...
#line 78
# 69 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartP.nc"
static inline error_t /*Msp430Uart0P.UartP*/Msp430UartP__1__Resource__request(uint8_t id)
#line 69
{
...
# 78 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t CarP__uart0resource__request(void ){
#line 78
  unsigned char __nesc_result;
#line 78

#line 78
  __nesc_result = /*Msp430Uart0P.UartP*/Msp430UartP__1__Resource__request(/*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID);
#line 78
...
{
  CarP__cmdlength = 7;
  CarP__CarCommand[0] = 0x01;
  CarP__CarCommand[1] = 0x02;
  if (CarP__isStart == TRUE && CarP__isSend == FALSE) 
    {
      CarP__isSend = TRUE;
      CarP__CarCommand[2] = 4;
      CarP__CarCommand[3] = 0x00;
      CarP__CarCommand[4] = 0x00;
      CarP__uart0resource__request();
    }
  else {
    return EBUSY;
    }
...
# 8 "Car.nc"
inline static error_t RadioToLedsC__Car__Pause(void ){
#line 8
  unsigned char __nesc_result;
#line 8
  ...
  if (CarP__isStart == TRUE && CarP__isSend == FALSE) 
    {
      ...
      CarP__CarCommand[2] = 2;
      CarP__CarCommand[4] = (uint8_t )(value & 0x00ff);
      value = value >> 8;
      CarP__CarCommand[3] = (uint8_t )value;
      CarP__uart0resource__request();
    }
  else {
    return EBUSY;
...
# 5 "Car.nc"
inline static error_t RadioToLedsC__Car__Forward(uint16_t value){
#line 5
  unsigned char __nesc_result;
#line 5
...
# 6 "Car.nc"
inline static error_t RadioToLedsC__Car__Back(uint16_t value){
#line 6
  unsigned char __nesc_result;
#line 6
...
#line 107
  ...
  if (len == sizeof(test_car_msg_t )) {
      ...
      if (__nesc_ntoh_uint32(rm->seq.nxdata) > RadioToLedsC__seq) {
          RadioToLedsC__seq = __nesc_ntoh_uint32(rm->seq.nxdata);
          switch (__nesc_ntoh_uint16(rm->cmd.nxdata)) 
            {
              case w_: 
                RadioToLedsC__Car__Back(200);
              break;
              case s_: 
                RadioToLedsC__Car__Forward(200);
              break;
              case a_: 
                if (RadioToLedsC__init_angle + 200 > 3800) {
                    break;
                  }
              RadioToLedsC__Car__Angle(RadioToLedsC__init_angle + 200);
              break;
              case d_: 
                if (RadioToLedsC__init_angle - 200 < 1800) {
                    break;
                  }
              RadioToLedsC__Car__Angle(RadioToLedsC__init_angle - 200);
              break;
              case __: 
                RadioToLedsC__Car__Pause();
              RadioToLedsC__Car__Angle((3800 + 1800) / 2);
              break;
              case _1: 
                RadioToLedsC__Car__QuiryReader(100);
              RadioToLedsC__id = 100;
              break;
              case _2: 
                RadioToLedsC__Car__QuiryReader(101);
              RadioToLedsC__id = 101;
              break;
              case _3: 
                RadioToLedsC__Car__QuiryReader(102);
              RadioToLedsC__id = 102;
              break;
              case _4: 
                RadioToLedsC__Car__QuiryReader(103);
              RadioToLedsC__id = 103;
              break;
              case _5: 
                RadioToLedsC__Car__QuiryReader(104);
              RadioToLedsC__id = 104;
              break;
              case _6: 
                RadioToLedsC__Car__QuiryReader(105);
              RadioToLedsC__id = 105;
              break;
              case _7: 
                RadioToLedsC__Car__QuiryReader(106);
              RadioToLedsC__id = 106;
              break;
              case _8: 
                RadioToLedsC__Car__QuiryReader(107);
              RadioToLedsC__id = 107;
              break;
              case _9: 
                RadioToLedsC__Car__QuiryReader(108);
              RadioToLedsC__id = 108;
              break;
              case _A: 
                RadioToLedsC__Car__QuiryReader(109);
              RadioToLedsC__id = 109;
              break;
              case _B: 
                RadioToLedsC__Car__QuiryReader(110);
              RadioToLedsC__id = 110;
              break;
              case _C: 
                RadioToLedsC__Car__QuiryReader(111);
              RadioToLedsC__id = 111;
              break;
              case _D: 
                RadioToLedsC__Car__QuiryReader(112);
              RadioToLedsC__id = 112;
              break;
              case _E: 
                RadioToLedsC__Car__QuiryReader(113);
              RadioToLedsC__id = 113;
              break;
              case _F: 
                RadioToLedsC__Car__QuiryReader(114);
              RadioToLedsC__id = 114;
              break;
              default: 
                break;
            }
  ...
  RadioToLedsC__Leds__led0Toggle();
  return msg;
}
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x4124f708, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x4124f708) {
#line 67
    case 2:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x4124f708, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40eb1648){
#line 92
  switch (arg_0x40eb1648) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40eb1648);
#line 92
      break;
#line 92
    }
...
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void CarP__Timer1__startOneShot(uint32_t dt){
#line 62
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startOneShot(1U, dt);
#line 62
}
#line 62
# 323 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart0P.nc"
static inline bool HplMsp430Usart0P__Usart__isTxEmpty(void )
#line 323
{
...
# 180 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart.nc"
inline static void CarP__Usart__enableRxIntr(void ){
#line 180
  HplMsp430Usart0P__Usart__enableRxIntr();
#line 180
}
...
static inline void CarP__uart0resource__granted(void )
{
  ...
  CarP__Usart__setModeUart(&CarP__config1);
  CarP__Usart__enableUart();
  CarP__Usart__enableRxIntr();
  U0CTL &= ~0x04;
  CarP__SendString(CarP__CarCommand, CarP__cmdlength);
  if (CarP__cmdlength == 4) {

    CarP__Timer1__startOneShot(1000);
    }
  else 
    {
#line 345
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart0P.UartP*/Msp430UartP__1__Resource__granted(uint8_t arg_0x408e4108){
#line 92
  switch (arg_0x408e4108) {
#line 92
    case /*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID:
#line 92
      CarP__uart0resource__granted();
#line 92
      break;
#line 92
    default:
#line 92
      /*Msp430Uart0P.UartP*/Msp430UartP__1__Resource__default__granted(arg_0x408e4108);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x40b03bd0){
#line 92
  switch (arg_0x40b03bd0) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 92
...
#line 92
    case /*CarC.Resourceusart0.UsartC*/Msp430Usart0C__1__CLIENT_ID:
#line 92
      /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__granted(/*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID);
#line 92
      break;
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x40b03bd0);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.1.1/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40eadb78, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x40eadb78) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40eadb78, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40e44010, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40e44010) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40e44010, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x4128fdf8, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x4128fdf8, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40e44010, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40e44010) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40e44010, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40e46558){
#line 92
  switch (arg_0x40e46558) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP__Resource__default__granted(arg_0x40e46558);
#line 92
      break;
#line 92
    }
...
#line 89
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x41252ca0, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__sendDone(arg_0x41252ca0, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
#line 117
  RadioToLedsC__DataControl__stopDone(error);
#line 117
}
#line 117
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t RadioToLedsC__DataControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
static inline void RadioToLedsC__DataControl__startDone(error_t error)
{
  if (error == SUCCESS) 
    ...
    {
      RadioToLedsC__DataControl__start();
    }
}
...
inline static void CarP__CarControl__startDone(error_t error){
#line 92
  RadioToLedsC__CarControl__startDone(error);
#line 92
}
#line 92
# 111 "CarP.nc"
static inline error_t CarP__CarControl__start(void )
{
  ...
  CarP__CarControl__startDone(SUCCESS);
  return SUCCESS;
}

# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t RadioToLedsC__CarControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83

#line 83
  __nesc_result = CarP__CarControl__start();
#line 83
...
#line 59
{
  if (err == SUCCESS) {
      ...
      RadioToLedsC__CarControl__start();
    }
  else 
#line 64
    {
...
#line 92
  RadioToLedsC__DataControl__startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
# 12 "Car.nc"
inline static error_t RadioToLedsC__Car__InitLeftServo(uint16_t value){
#line 12
  unsigned char __nesc_result;
#line 12

#line 12
  __nesc_result = CarP__Car__InitLeftServo(value);
#line 12
...
# 13 "Car.nc"
inline static error_t RadioToLedsC__Car__InitRightServo(uint16_t value){
#line 13
  unsigned char __nesc_result;
#line 13

#line 13
  __nesc_result = CarP__Car__InitRightServo(value);
#line 13
...
# 14 "Car.nc"
inline static error_t RadioToLedsC__Car__InitMidServo(uint16_t value){
#line 14
  unsigned char __nesc_result;
#line 14

#line 14
  __nesc_result = CarP__Car__InitMidServo(value);
#line 14
...
# 23 "/opt/tinyos-2.1.1/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x40835b10, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x40835b10) {
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x40835b10, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x40835b10){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x40835b10);
#line 15
      break;
#line 15
    }
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x40b79e48, message_t * msg, error_t error){
#line 89
  switch (arg_0x40b79e48) {
#line 89
    case 0U:
...
#line 89
    default:
#line 89
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x40b79e48, msg, error);
#line 89
      break;
#line 89
    }
...
# 57 "/opt/tinyos-2.1.1/tos/system/BigQueueC.nc"
static inline uint16_t /*PrintfC.QueueC*/BigQueueC__0__Queue__size(void )
#line 57
{
...
# 58 "/opt/tinyos-2.1.1/tos/interfaces/BigQueue.nc"
...
#line 115
# 69 "/opt/tinyos-2.1.1/tos/system/BigQueueC.nc"
static inline void /*PrintfC.QueueC*/BigQueueC__0__printQueue(void )
#line 69
{
}
...
# 81 "/opt/tinyos-2.1.1/tos/interfaces/BigQueue.nc"
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x408e4108){
#line 92
  switch (arg_0x408e4108) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x408e4108);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40b03bd0){
#line 92
  switch (arg_0x40b03bd0) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40b03bd0);
#line 92
      break;
#line 92
    }
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40b00a58){
#line 49
  switch (arg_0x40b00a58) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40b00a58);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x408e01b8){
#line 39
  union __nesc_unnamed4288 *__nesc_result;
#line 39

#line 39
  switch (arg_0x408e01b8) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x408e01b8);
#line 39
      break;
#line 39
    }
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x40771ae8, message_t * msg, error_t error){
#line 99
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x40771ae8, msg, error);
#line 99
}
#line 99
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x40835010, message_t * msg, error_t error){
#line 89
  switch (arg_0x40835010) {
#line 89
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 89
...
#line 89
    default:
#line 89
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x40835010, msg, error);
#line 89
      break;
#line 89
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x4077c548, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x4077c548, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x40838918, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x40838918) {
#line 67
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x40838918, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 31 "/opt/tinyos-2.1.1/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x40835b10, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x40835b10, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40b00a58){
#line 55
  switch (arg_0x40b00a58) {
#line 55
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40b00a58);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0x408e1718){
#line 110
  unsigned char __nesc_result;
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0x408e1718);
#line 110
      break;
#line 110
    }
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x408e1718){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x408e1718);
#line 118
      break;
#line 118
    }
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void RadioToLedsC__ResendTimer__startPeriodic(uint32_t dt){
#line 53
...
{
  RadioToLedsC__AMControl__start();
  RadioToLedsC__ResendTimer__startPeriodic(2000);
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40b02690){
#line 51
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40b02690);
#line 51
}
#line 51
# 90 "/opt/tinyos-2.1.1/tos/system/ArbiterP.nc"
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0x408e1718){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0x408e1718);
#line 87
      break;
#line 87
    }
...
# 79 "/opt/tinyos-2.1.1/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x408e22c8, uint8_t byte){
#line 79
  switch (arg_0x408e22c8) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x408e22c8, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x408e22c8, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x408e22c8) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x408e22c8, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x40ae2ce8, uint8_t data){
#line 54
  switch (arg_0x40ae2ce8) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x40ae2ce8, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x408e22c8, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x408e22c8) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x408e22c8, buf, len, error);
#line 57
      break;
#line 57
    }
...
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x40ae2ce8){
#line 49
  switch (arg_0x40ae2ce8) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x40ae2ce8);
#line 49
      break;
#line 49
    }
...
#line 89
# 50 "/opt/tinyos-2.1.1/tos/interfaces/BigQueue.nc"
...
#line 50
# 61 "/opt/tinyos-2.1.1/tos/system/BigQueueC.nc"
static inline uint16_t /*PrintfC.QueueC*/BigQueueC__0__Queue__maxSize(void )
#line 61
{
  return 1024;
...
# 79 "/opt/tinyos-2.1.1/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart0P.UartP*/Msp430UartP__1__UartStream__receivedByte(uint8_t arg_0x408e22c8, uint8_t byte){
#line 79
    /*Msp430Uart0P.UartP*/Msp430UartP__1__UartStream__default__receivedByte(arg_0x408e22c8, byte);
#line 79
}
#line 79
# 222 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartP.nc"
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart0P.UartP*/Msp430UartP__1__UartStream__receiveDone(uint8_t arg_0x408e22c8, uint8_t * buf, uint16_t len, error_t error){
#line 99
    /*Msp430Uart0P.UartP*/Msp430UartP__1__UartStream__default__receiveDone(arg_0x408e22c8, buf, len, error);
#line 99
}
#line 99
# 134 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartP.nc"
...
# 54 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x40ae2ce8, uint8_t data){
#line 54
  switch (arg_0x40ae2ce8) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 54
    case /*CarC.Resourceusart0.UsartC*/Msp430Usart0C__1__CLIENT_ID:
#line 54
      /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartInterrupts__rxDone(/*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID, data);
#line 54
      break;
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x40ae2ce8, data);
#line 54
      break;
#line 54
    }
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__isOwner(uint8_t arg_0x408e1718){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    case /*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID:
#line 118
      __nesc_result = /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__isOwner(/*CarC.Resourceusart0.UsartC*/Msp430Usart0C__1__CLIENT_ID);
#line 118
      break;
#line 118
    default:
#line 118
      __nesc_result = /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__default__isOwner(arg_0x408e1718);
#line 118
      break;
#line 118
    }
...
#line 118
# 73 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartP.nc"
static inline uint8_t /*Msp430Uart0P.UartP*/Msp430UartP__1__Resource__isOwner(uint8_t id)
#line 73
{
  return /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__isOwner(id);
}

# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool CarP__uart0resource__isOwner(void ){
#line 118
  unsigned char __nesc_result;
#line 118

#line 118
  __nesc_result = /*Msp430Uart0P.UartP*/Msp430UartP__1__Resource__isOwner(/*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID);
#line 118
...
static inline void CarP__Interrupts__rxDone(uint8_t data)
{
  ...
  if (CarP__isUartDataOk == FALSE && CarP__uart0resource__isOwner() == TRUE) 
    {
      if (CarP__SyncData[CarP__rcvSyncDataSum] == data) 
        {
          CarP__rcvSyncDataSum++;
          if (CarP__rcvSyncDataSum == SYNC_DATA_SUM) 
            {

              CarP__isUartDataOk = TRUE;
              CarP__nreading = 0;
            }
        }
      else 
  ...
  if (CarP__isBufFull == FALSE && CarP__isUartDataOk == TRUE && CarP__uart0resource__isOwner() == TRUE) 
    {
      if (CarP__nreading < MAX_DATA) 
        {
          CarP__recdata[CarP__nreading++] = data;
        }
      if (CarP__nreading == MAX_DATA) 
        {
          CarP__isBufFull = TRUE;
          CarP__Timer1__stop();


          if (CarP__recdata[0] == 0x00 && CarP__recdata[1] == 0x00) 
            {

              CarP__tagdata = CarP__recdata[MAX_DATA - 2] * 256 + CarP__recdata[MAX_DATA - 1];
              CarP__statetag = SUCCESS;
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__fired(uint8_t arg_0x40adfcf8){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__default__fired(arg_0x40adfcf8);
#line 39
}
#line 39
...
# 57 "/opt/tinyos-2.1.1/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart0P.UartP*/Msp430UartP__1__UartStream__sendDone(uint8_t arg_0x408e22c8, uint8_t * buf, uint16_t len, error_t error){
#line 57
    /*Msp430Uart0P.UartP*/Msp430UartP__1__UartStream__default__sendDone(arg_0x408e22c8, buf, len, error);
#line 57
}
#line 57
# 224 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart.nc"
...
# 49 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x40ae2ce8){
#line 49
  switch (arg_0x40ae2ce8) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    case /*CarC.Resourceusart0.UsartC*/Msp430Usart0C__1__CLIENT_ID:
#line 49
      /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartInterrupts__txDone(/*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID);
#line 49
      break;
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x40ae2ce8);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x4067e4b0){
#line 28
  switch (arg_0x4067e4b0) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x4067e4b0);
#line 28
      break;
#line 28
    }
...
# 290 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart0P.nc"
static void HplMsp430Usart0P__Usart__setModeUart(msp430_uart_union_config_t *config)
#line 290
{
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x405f04a0){
#line 64
  switch (arg_0x405f04a0) {
#line 64
    case SerialP__RunTx:
#line 64
...
#line 64
    case CarP__recvTask:
#line 64
      CarP__recvTask__runTask();
#line 64
      break;
#line 64
    default:
#line 64
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x405f04a0);
#line 64
      break;
#line 64
    }
...
static void RadioToLedsC__Car__readDone(error_t state, uint16_t data)
{
  if (state == SUCCESS) 
    {
      RadioToLedsC__current_data = data;
      RadioToLedsC__resend_count = 0;
      RadioToLedsC__sendData();
    }
...
#line 217
{
  test_data_msg_t *tdm_pkt = (test_data_msg_t *)RadioToLedsC__DataPacket__getPayload(&RadioToLedsC__packet, sizeof(test_data_msg_t ));

#line 219
  __nesc_hton_int16(tdm_pkt->id.nxdata, RadioToLedsC__id);
  __nesc_hton_int16(tdm_pkt->data.nxdata, RadioToLedsC__current_data);
  if (!RadioToLedsC__busy_radio) 
    {
      if (RadioToLedsC__DataSend__send(AM_BROADCAST_ADDR, &RadioToLedsC__packet, sizeof(test_data_msg_t ))) 
        {
  ...
  RadioToLedsC__Leds__led1Toggle();
}
...
# 121 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430SpiNoDmaP.nc"
static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__continueOp(void )
#line 121
{
...
static error_t CarP__Car__QuiryReader(uint8_t value)
{
  ...
  if (CarP__isStart == TRUE && CarP__isSend == FALSE) 
    {
      CarP__isSend = TRUE;
      CarP__CarCommand[2] = 11;
      CarP__CarCommand[3] = value;
      CarP__uart0resource__request();
    }
  else 
    {
  ...
  if (error == SUCCESS) 
    {
      ...
      RadioToLedsC__Car__InitLeftServo(3800);
      RadioToLedsC__Car__InitRightServo(1800);
      RadioToLedsC__Car__InitMidServo((3800 + 1800) / 2);
      RadioToLedsC__DataControl__start();
    }
  else 
    {
